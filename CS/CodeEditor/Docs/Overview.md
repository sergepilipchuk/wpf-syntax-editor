...
`CodeEditor` is a WPF control that embeds the [Monaco Editor](https://microsoft.github.io/monaco-editor/) (the editor engine used by Visual Studio Code) via [Microsoft WebView2](https://learn.microsoft.com/en-us/microsoft-edge/webview2/).
...
<Window
    ...
    xmlns:se="clr-namespace:CodeEditor;assembly=CodeEditor">
